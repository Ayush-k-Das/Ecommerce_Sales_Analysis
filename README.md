...
This project focuses on analyzing an **E-commerce Sales Dataset** using **Excel** and **Tableau** to uncover business insights, identify trends, and visualize key performance metrics.  
...
- Certain product categories contribute the most to revenue.  
- Discounts affect profit margins and need optimization.  
- Regional variations in sales performance highlight targeted strategies.  

## 🚀 How to Use
1. Clone this repository:
   ```bash
   git clone https://github.com/Ayush-k-Das/Ecommerce_Sales_Analysis.git
Open the dataset (ecommerce_dataset.csv) in Excel or Tableau.
...
Adding predictive modeling for sales forecasting.

Expanding dashboard interactivity with more KPIs.
